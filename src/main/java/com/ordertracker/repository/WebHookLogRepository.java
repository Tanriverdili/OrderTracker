...
public interface WebHookLogRepository extends JpaRepository<WebhookLogEntity, Long> {
    ...
    List<WebhookLogEntity> findByReceivedAtBetween(LocalDateTime start, LocalDateTime end);
    List<WebhookLogEntity> findByStatusIgnoreCaseAndReceivedAtBetween(String status, LocalDateTime start, LocalDateTime end);
